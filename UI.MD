...
The Agartha prototype leans on Tailwind CSS and lightweight React components to deliver a cohesive member experience. This reference maps major pages to their supporting components and highlights reusable primitives.
...
| `/` | Home with Members/Communities tabs. | [`components/ProfileCard.tsx`](./components/ProfileCard.tsx), [`components/ProjectRoster.tsx`](./components/ProjectRoster.tsx) (in list contexts). |
...
| `/communities` & `/communities/[id]` | Explore communities and residencies. | Card primitives, ProfileCard for member callouts, CommentsThread for community discussions. |
